...
namespace eyeWearShop.Repositories.Basis
{
    public class GenericRepo<T> where T : class
    {
        protected Prn222EyewearshopContext _context;

        public GenericRepo()
        {
            _context ??= new Prn222EyewearshopContext();
        }

        public GenericRepo(Prn222EyewearshopContext context)
        {
            _context = context;
        }
